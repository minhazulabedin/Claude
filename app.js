...
const AMENITIES = {
  police: [
    // North — Uttara / Turag / Khilkhet belt
    { n: 'Uttarkhan PS', a: 'Uttarkhan', x: 0.55, y: 0.02 },
    { n: 'Dakshinkhan PS', a: 'Dakshinkhan', x: 0.62, y: 0.04 },
    { n: 'Uttara West PS', a: 'Uttara', x: 0.49, y: 0.05 },
    { n: 'Uttara East PS', a: 'Uttara', x: 0.58, y: 0.07 },
    { n: 'Turag PS', a: 'Turag', x: 0.41, y: 0.06 },
    { n: 'Airport PS', a: 'Bimanbandar', x: 0.55, y: 0.12 },
    { n: 'Khilkhet PS', a: 'Khilkhet', x: 0.63, y: 0.14 },
    // North-central — Mirpur / Pallabi / Cantonment
    { n: 'Pallabi PS', a: 'Pallabi', x: 0.33, y: 0.18 },
    { n: 'Rupnagar PS', a: 'Rupnagar', x: 0.36, y: 0.21 },
    { n: 'Bhashantek PS', a: 'Bhashantek', x: 0.45, y: 0.18 },
    { n: 'Kafrul PS', a: 'Kafrul', x: 0.46, y: 0.23 },
    { n: 'Cantonment PS', a: 'Cantonment', x: 0.51, y: 0.20 },
    { n: 'Shah Ali PS', a: 'Mirpur', x: 0.27, y: 0.24 },
    { n: 'Mirpur PS', a: 'Mirpur', x: 0.30, y: 0.27 },
    { n: 'Darus Salam PS', a: 'Darus Salam', x: 0.33, y: 0.31 },
    // North-east — Gulshan / Banani / Badda / Vatara
    { n: 'Banani PS', a: 'Banani', x: 0.56, y: 0.28 },
    { n: 'Gulshan PS', a: 'Gulshan', x: 0.63, y: 0.31 },
    { n: 'Bhatara PS', a: 'Vatara', x: 0.73, y: 0.26 },
    { n: 'Badda PS', a: 'Badda', x: 0.72, y: 0.39 },
    { n: 'Rampura PS', a: 'Rampura', x: 0.66, y: 0.44 },
    // Central — Tejgaon / Mohakhali / Hatirjheel
    { n: 'Mohakhali (Banani) PS', a: 'Mohakhali', x: 0.52, y: 0.34 },
    { n: 'Sher-e-Bangla Nagar PS', a: 'Agargaon', x: 0.42, y: 0.37 },
    { n: 'Tejgaon PS', a: 'Tejgaon', x: 0.50, y: 0.40 },
    { n: 'Tejgaon I/A PS', a: 'Tejgaon Industrial', x: 0.56, y: 0.42 },
    { n: 'Hatirjheel PS', a: 'Hatirjheel', x: 0.58, y: 0.41 },
    // West — Mohammadpur / Adabor / Hazaribagh
    { n: 'Adabor PS', a: 'Adabor', x: 0.24, y: 0.40 },
    { n: 'Mohammadpur PS', a: 'Mohammadpur', x: 0.27, y: 0.44 },
    { n: 'Hazaribagh PS', a: 'Hazaribagh', x: 0.30, y: 0.55 },
    { n: 'Kamrangirchar PS', a: 'Kamrangirchar', x: 0.31, y: 0.72 },
    // Central-west — Dhanmondi / New Market
    { n: 'Dhanmondi PS', a: 'Dhanmondi', x: 0.36, y: 0.47 },
    { n: 'Kalabagan PS', a: 'Kalabagan', x: 0.42, y: 0.47 },
    { n: 'New Market PS', a: 'New Market', x: 0.43, y: 0.52 },
    // Central — Ramna / Shahbagh / Paltan
    { n: 'Ramna PS', a: 'Ramna', x: 0.49, y: 0.53 },
    { n: 'Shahbagh PS', a: 'Shahbagh', x: 0.45, y: 0.55 },
    { n: 'Paltan PS', a: 'Paltan', x: 0.51, y: 0.57 },
    // East-central — Khilgaon / Sabujbagh / Mugda
    { n: 'Khilgaon PS', a: 'Khilgaon', x: 0.62, y: 0.55 },
    { n: 'Sabujbagh PS', a: 'Sabujbagh', x: 0.64, y: 0.59 },
    { n: 'Mugda PS', a: 'Mugda', x: 0.58, y: 0.59 },
    // South-central — Motijheel / Shahjahanpur
    { n: 'Motijheel PS', a: 'Motijheel', x: 0.50, y: 0.62 },
    { n: 'Shahjahanpur PS', a: 'Shahjahanpur', x: 0.56, y: 0.60 },
    // Old Dhaka
    { n: 'Lalbagh PS', a: 'Lalbagh', x: 0.36, y: 0.66 },
    { n: 'Chawkbazar PS', a: 'Chawkbazar', x: 0.40, y: 0.68 },
    { n: 'Bangshal PS', a: 'Bangshal', x: 0.46, y: 0.66 },
    { n: 'Kotwali PS', a: 'Old Dhaka', x: 0.45, y: 0.71 },
    { n: 'Sutrapur PS', a: 'Sutrapur', x: 0.50, y: 0.70 },
    { n: 'Wari PS', a: 'Wari', x: 0.52, y: 0.68 },
    { n: 'Gendaria PS', a: 'Gendaria', x: 0.48, y: 0.73 },
    // South — Shyampur / Kadamtali / Jatrabari / Demra
    { n: 'Shyampur PS', a: 'Shyampur', x: 0.55, y: 0.74 },
    { n: 'Kadamtali PS', a: 'Kadamtali', x: 0.58, y: 0.77 },
    { n: 'Jatrabari PS', a: 'Jatrabari', x: 0.62, y: 0.73 },
    { n: 'Demra PS', a: 'Demra', x: 0.73, y: 0.72 },
    { n: 'Dania PS', a: 'Dania', x: 0.62, y: 0.78 },
  ],
  metro: [
  ...
  fuel: [
    ...
    { n: 'Airport Filling Station', a: 'Bimanbandar', x: 0.56, y: 0.13 },
    { n: 'Khilkhet CNG', a: 'Khilkhet', x: 0.63, y: 0.15 },
    { n: 'Pallabi Filling Station', a: 'Pallabi', x: 0.34, y: 0.19 },
    { n: 'Mirpur CNG & Fuel', a: 'Mirpur', x: 0.32, y: 0.28 },
    { n: 'Kazipara Fuel Pump', a: 'Kazipara', x: 0.43, y: 0.30 },
    { n: 'Banani Petrol Pump', a: 'Banani', x: 0.56, y: 0.29 },
    { n: 'Gulshan Filling Station', a: 'Gulshan', x: 0.62, y: 0.34 },
    { n: 'Badda CNG Station', a: 'Badda', x: 0.71, y: 0.40 },
    { n: 'Rampura Filling Station', a: 'Rampura', x: 0.66, y: 0.45 },
    { n: 'Mohakhali Petrol Pump', a: 'Mohakhali', x: 0.52, y: 0.36 },
    { n: 'Tejgaon Fuel Station', a: 'Tejgaon', x: 0.50, y: 0.43 },
    { n: 'Farmgate Filling Station', a: 'Farmgate', x: 0.47, y: 0.45 },
    { n: 'Shyamoli Filling Station', a: 'Shyamoli', x: 0.30, y: 0.41 },
    { n: 'Mohammadpur CNG', a: 'Mohammadpur', x: 0.27, y: 0.45 },
    { n: 'Dhanmondi Filling Station', a: 'Dhanmondi', x: 0.36, y: 0.49 },
    { n: 'Science Lab CNG', a: 'New Market', x: 0.41, y: 0.51 },
    { n: 'Khilgaon Filling Station', a: 'Khilgaon', x: 0.62, y: 0.56 },
    { n: 'Motijheel Petrol Pump', a: 'Motijheel', x: 0.51, y: 0.62 },
    { n: 'Lalbagh CNG', a: 'Lalbagh', x: 0.36, y: 0.66 },
    { n: 'Postagola Fuel Station', a: 'Postagola', x: 0.50, y: 0.75 },
    { n: 'Jatrabari Fuel & CNG', a: 'Jatrabari', x: 0.60, y: 0.73 },
    { n: 'Demra Filling Station', a: 'Demra', x: 0.72, y: 0.71 },
  ],
  hospital: [
    { n: 'Kuwait-Bangladesh Friendship', a: 'Uttara', x: 0.54, y: 0.08 },
    { n: 'Crescent Hospital', a: 'Uttara', x: 0.52, y: 0.10 },
    { n: 'Kurmitola General Hospital', a: 'Cantonment', x: 0.55, y: 0.17 },
    { n: 'Combined Military (CMH)', a: 'Cantonment', x: 0.53, y: 0.19 },
    { n: 'National Heart Foundation', a: 'Mirpur', x: 0.36, y: 0.27 },
    { n: 'Delta Medical College', a: 'Mirpur', x: 0.34, y: 0.25 },
    { n: 'United Hospital', a: 'Gulshan', x: 0.66, y: 0.33 },
    { n: 'Evercare Hospital', a: 'Bashundhara', x: 0.75, y: 0.28 },
    { n: 'icddr,b', a: 'Mohakhali', x: 0.52, y: 0.33 },
    { n: 'National Cancer Institute', a: 'Mohakhali', x: 0.50, y: 0.34 },
    { n: 'Shaheed Suhrawardy (ShSMCH)', a: 'Sher-e-Bangla Nagar', x: 0.42, y: 0.37 },
    { n: 'NICVD (Heart)', a: 'Sher-e-Bangla Nagar', x: 0.43, y: 0.36 },
    { n: 'Bangladesh Medical College', a: 'Shyamoli', x: 0.30, y: 0.40 },
    { n: 'Square Hospital', a: 'Panthapath', x: 0.43, y: 0.46 },
    { n: 'Anwer Khan Modern', a: 'Dhanmondi', x: 0.38, y: 0.46 },
    { n: 'Labaid Hospital', a: 'Dhanmondi', x: 0.37, y: 0.48 },
    { n: 'Popular Diagnostic', a: 'Dhanmondi', x: 0.38, y: 0.47 },
    { n: 'Ibn Sina Hospital', a: 'Dhanmondi', x: 0.36, y: 0.49 },
    { n: 'Holy Family Red Crescent', a: 'Eskaton', x: 0.50, y: 0.52 },
    { n: 'BIRDEM General', a: 'Shahbagh', x: 0.46, y: 0.54 },
    { n: 'BSMMU (PG Hospital)', a: 'Shahbagh', x: 0.45, y: 0.55 },
    { n: 'Dhaka Medical College (DMCH)', a: 'Shahbagh', x: 0.44, y: 0.58 },
    { n: 'Mugda Medical College', a: 'Mugda', x: 0.58, y: 0.58 },
    { n: 'Islami Bank Hospital', a: 'Motijheel', x: 0.50, y: 0.61 },
    { n: 'Sir Salimullah (Mitford)', a: 'Old Dhaka', x: 0.43, y: 0.70 },
  ],
  fire: [
    { n: 'Uttara Fire Station', a: 'Uttara', x: 0.53, y: 0.07 },
    { n: 'Dakshinkhan Fire Station', a: 'Dakshinkhan', x: 0.61, y: 0.05 },
    { n: 'Airport Fire Station', a: 'Bimanbandar', x: 0.55, y: 0.13 },
    { n: 'Pallabi Fire Station', a: 'Pallabi', x: 0.34, y: 0.19 },
    { n: 'Mirpur Fire Station', a: 'Mirpur', x: 0.31, y: 0.26 },
    { n: 'Kurmitola Fire Station', a: 'Cantonment', x: 0.53, y: 0.19 },
    { n: 'Baridhara Fire Station', a: 'Gulshan', x: 0.66, y: 0.30 },
    { n: 'Mohakhali Fire Station', a: 'Mohakhali', x: 0.53, y: 0.35 },
    { n: 'Badda Fire Station', a: 'Badda', x: 0.71, y: 0.41 },
    { n: 'Tejgaon Fire Station', a: 'Tejgaon', x: 0.49, y: 0.42 },
    { n: 'Mohammadpur Fire Station', a: 'Mohammadpur', x: 0.27, y: 0.44 },
    { n: 'Khilgaon Fire Station', a: 'Khilgaon', x: 0.62, y: 0.56 },
    { n: 'Polashi Fire Station', a: 'Polashi', x: 0.44, y: 0.59 },
    { n: 'Siddique Bazar HQ', a: 'Old Dhaka', x: 0.46, y: 0.64 },
    { n: 'Hazaribagh Fire Station', a: 'Hazaribagh', x: 0.34, y: 0.62 },
    { n: 'Sadarghat Fire Station', a: 'Old Dhaka', x: 0.46, y: 0.73 },
    { n: 'Postagola Fire Station', a: 'Postagola', x: 0.50, y: 0.76 },
    { n: 'Demra Fire Station', a: 'Demra', x: 0.72, y: 0.72 },
  ],
};
...
function renderZones() {
  ...
  screen.innerHTML = `
    <section class="view">
      ...
      <p class="note">Landmark coverage: ${AMENITIES.police.length} police thanas · ${AMENITIES.metro.length} metro stations · ${AMENITIES.hospital.length} hospitals · ${AMENITIES.fuel.length} fuel/CNG · ${AMENITIES.fire.length} fire stations.</p>
